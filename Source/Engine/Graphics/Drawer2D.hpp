...
public:
    ...
    // Vertexes, Type, Layer
    void DrawPolygon(const std::vector<SVertexPC>&, const EPrimitiveMode, const float);
    // Vertexes, Type, Transform, Layer
    void DrawPolygon(const std::vector<SVertexPC>&, const EPrimitiveMode, const Matrix3&, const float);

    // Position, Color, Layer
    void DrawPoint(const Vector2&, const Color&, const float);
    // Position, Color, Transform, Layer
    void DrawPoint(const Vector2&, const Color&, const Matrix3&, const float);

    // Start, Stop, Color, Layer
    void DrawLine(const Vector2&, const Vector2&, const Color&, const float);
    // Start, Stop, Color, Transform, Layer
    void DrawLine(const Vector2&, const Vector2&, const Color&, const Matrix3&, const float);

    // Rect, Fill, Color, Layer
    void DrawRect(const Rect2&, const bool, const Color&, const float);
    // Rect, Fill, Color, Transform, Layer
    void DrawRect(const Rect2&, const bool, const Color&, const Matrix3&, const float);
    ...
    void DrawText(IFont*, const std::string&, const Vector2&, const int, const Color&, const Matrix3&, const float);
    ...
    void DrawTexture(ITexture2D*, const Rect2&, const Rect2&, const ETextureFlip, const Matrix3&, const float);
private:
    IGraphics* Graphics = nullptr;
    CResources* Resources = nullptr;
    IWindow* Window = nullptr;
    std::unique_ptr<IVertexBufferColorTexCoords> VertexBuffer;
